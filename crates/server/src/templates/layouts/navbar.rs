        ...
        div class="nav-bar" {
            ...
            div class="auth-container" {
                ...
                div id="userInfoArea" class="is-hidden" {
                    span id="usernameDisplay" class="nes-text is-primary" style="cursor: pointer;" title="View Profile" {}
                    button class="nes-btn is-warning" id="profileBtn" {
                        "Profile"
                    }
